...
exports.generateRegistrationId = function() {
    try {
        ...
        console.error("Registration ID generation error:", error.message);
        return null;
    }
};
...
exports.generateSignedPreKey = function(identityKeyPair, signedKeyId) {
    try {
        ...
        console.error("Signed PreKey generation error:", error.message);
        return null;
    }
};
...
exports.generatePreKey = function(keyId) {
    try {
        ...
        console.error("PreKey generation error:", error.message);
        return null;
    }
};